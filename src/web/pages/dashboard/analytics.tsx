...
const AnalyticsPage = () => {
  const { items, isLoading, refreshItems } = useItems();
          ...
          <Card className="animate-slide-up">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-muted-foreground max-w-sm mx-auto">
                Add items to your inventory to see analytics and insights about your stock. 
                Go to the Table page to add your first item.
              </p>
            </CardContent>
          </Card>
        ) : (
